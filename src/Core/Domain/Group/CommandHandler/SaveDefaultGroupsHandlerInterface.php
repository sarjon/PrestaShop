...
/**
 * Interface for service that handles Default Groups configuration saving
 */
interface SaveDefaultGroupsHandlerInterface
{
    /**
     * @param SaveDefaultGroupsCommand $command
     */
