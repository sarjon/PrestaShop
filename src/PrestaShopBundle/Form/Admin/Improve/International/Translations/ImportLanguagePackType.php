...
/**
 * Is used to create form for importing language pack manually
 */
class ImportLanguagePackType extends AbstractType
{
    /**
     * @var array
     */
    ...
    {
        $builder
            ->add('language_pack_to_import', FileType::class, [
            ])
